  ...
  constructor(props) {
    ...
    this.state = {
      HopitalStores: [
        ...
        {
          namePharma: 'Pharmacie St Cécile',
          image: require('../../assets/ventoline.jpg'),
          nameMedicament: 'Ventoline',
          quantité: 'Quantité',
          prix: '4.865 F CFA',
          key: '2',
        },
