      ...
      <ScrollView>
        <View style={{margin: 10}}>
          ...
          <View
            ...
            <View
              style={{flexDirection: 'row', margin: 10, marginHorizontal: 15}}>
              <Text
                style={{
                  alignSelf: 'flex-end',
                  color: 'red',
        ...
        <View style={styles.container}>
          <Text style={styles.title}>Date et heures</Text>
          <DatePicker
        ...
        <View
          ...
          <View
            ...
            <View style={{width: 60, borderRadius: 10, height: 30}}>
              <TouchableOpacity>
                <Text
                  style={{alignItems: 'center', alignSelf: 'center', top: 5}}>
                  09:30
                </Text>
              </TouchableOpacity>
            </View>
        ...
        <Text style={{margin: 20, color: '#3ABDB7', fontSize: 16}}>
        ...
        <View style={{width: '100%'}}>
          <TouchableOpacity
            ...
            onPress={showModal}>
            <Text style={styles.customBtnTextConnecter}>
        ...
        <Portal>
          <Modal
            ...
            <Text style={{textAlign: 'center', fontSize: 20, marginBottom: 10}}>
              Mercredi 09 Avril à <Text style={{color: '#3ABDB7'}}>08:00 </Text>
            </Text>
