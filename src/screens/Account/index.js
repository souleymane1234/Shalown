        ...
        return (
            <SafeAreaView style={styles.container}>
                    ...
                    <View style={styles.textBienvenueView}>
                        ...
                        <Text style={styles.textConnexion}>veulliez vous connecter ou vous {"\n"} inscrire pour continuer a utiliser {"\n"} notre application</Text>
                    </View>
                    ...
                    <View style={{flexDirection: 'row', margin: 10, alignSelf: 'center', justifyContent: 'space-around', width: '50%', top: 10}}>
                        <Facebook/>
