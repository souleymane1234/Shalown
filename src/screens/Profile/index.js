    ...
    render () {
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: '#D8D8D8'}}>
                ...
                <View style={{backgroundColor: '#F3F3F3', borderTopEndRadius: 30, borderTopLeftRadius: 30, top: -10}}>
                    <ScrollView>
                        ...
                        <Image source={require('../../assets/ID.jpg')} style={{width: 100, height: 100, borderRadius: 50, }}/>
                        <Text style={{color: '#3ABDB7', fontSize: 10, marginBottom: 6, textAlign: 'center' }}>Editer le profile</Text>
                        <Text style={{fontSize: 16, textAlign: 'center', marginBottom: 6}}>Salut Kanania!</Text>
                        <TouchableHighlight>
                            <Text style={{fontSize: 12, color: 'red', textAlign: 'center'}}>Se séconnecter</Text>
                        </TouchableHighlight>
                        </View>
