        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
                ...
                <View style={{backgroundColor: '#3ABDB7', alignContent: 'center', flexDirection: 'row', justifyContent: 'space-around'}}>
                    <Text style={{fontSize: 20, color: '#fff', alignSelf: 'center'}}>Prendre un rendez-vous</Text>
                ...
                <View style={{backgroundColor: '#3ABDB7', alignContent: 'center', flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 20, color: '#fff', alignSelf: 'center', marginHorizontal: 20}}>Prendre un rendez-vous</Text>
                </View>
                    ...
                    <View style={{margin: 10,  marginHorizontal: 20}}>
                        ...
                        <View>
                            <Text style={{fontSize: 18, marginBottom: 10}}>
                                - Kinésithérapie - Chirurgie - Orthopédie - Radiographie - dentiste
                            </Text>
